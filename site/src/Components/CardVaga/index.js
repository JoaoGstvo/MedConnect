        ...
        <div className='job-card'>
            <div className='job-content'>
                <div className='job-header'>
                    ...
                    <p className='company-name'><strong>Hospital do Coração</strong></p>
                </div>
                ...
                <div className='salary-section'>
                    <p className='salary-range'><strong>R$ 15.000 - R$ 25.000</strong></p>
                </div>

                <div className='job-description'>
                    <p>Procuramos médico cardiologista experiente para integrar nossa equipe. Responsável por consultas, procedimentos e cirurgias cardiovasculares.</p>
                </div>
